...
const Inputs = ({setQuery, units, setUnits}) => {
  ...
  const handleLocationClick = () => {
    if(navigator.geolocation) {
      ...
      toast.success("Location fetched!",{hideProgressBar: true,})
  ...
  return (
    <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify-center space-x-4">
            ...
            />
            <UilSearch size={25} className="text-white cursor-pointer transition east-out hover:scale-125" 
              onClick={handleSearchClick}
            />
            <UilLocationPoint size={25} className="text-white cursor-pointer transition east-out hover:scale-125"
